              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'flex-start'}}>
                  ...
                  <div style={{ flex: '0 0 60%', width: '60%', paddingLeft: '3%' }}>
                    ...
                    <PageLayout key={index} title={` Java Programming Language: ${type} Questions`} sidebarOpen={{sidebarOpen}} icon={languageIcons['java']}/>
                  </div>
                  ...
                  <Box key={type} sx={{ mb: 4 }}>
                    {(() => {
                      ...
                      return filtered.length > 0 ? (
                        filtered.map((question, i) => <QuizContent key={i} question={question} language={language} />)
                      ) : (
